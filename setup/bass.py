...
class BASSExtensionHandler(ExtensionHandler):
    ...
    def GetExtensions(self):
        return [
            ...
            Extension(
                "Bass4Py.bass.version", ["Bass4Py/bass/version.pyx"], language="c"
            ),
            Extension(
                "Bass4Py.evaluable",
            ...
            Extension("Bass4Py.constants", ["Bass4Py/constants.pyx"], language="c"),
            Extension(
    ...
    def GetDataFiles(self):
        ...
        if platform.system() == "Windows":
            if IsX64():
                files.update(
                    {"Bass4Py.bass": [os.path.join("bass24", "x64", "bass.dll")]}
                )
            else:
