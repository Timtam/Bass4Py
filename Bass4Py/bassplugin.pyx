...
cdef class BASSPLUGIN:
 ...
 cdef bass.BASS_PLUGININFO* __getinfo(BASSPLUGIN self):
  cdef bass.BASS_PLUGININFO *info=bass.BASS_PluginGetInfo(self.__plugin)
  return info
 ...
 property Version:
  def __get__(BASSPLUGIN self):
   cdef bass.BASS_PLUGININFO* info=self.__getinfo()
   self.__Evaluate()
