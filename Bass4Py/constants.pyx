...
class ERROR(IntEnum):
  OK = bass._BASS_OK
  MEM = bass._BASS_ERROR_MEM
  FILEOPEN = bass._BASS_ERROR_FILEOPEN
  DRIVER = bass._BASS_ERROR_DRIVER
  BUFLOST = bass._BASS_ERROR_BUFLOST
  HANDLE = bass._BASS_ERROR_HANDLE
  FORMAT = bass._BASS_ERROR_FORMAT
  POSITION = bass._BASS_ERROR_POSITION
  INIT = bass._BASS_ERROR_INIT
  START = bass._BASS_ERROR_START
  SSL = bass._BASS_ERROR_SSL
  ALREADY = bass._BASS_ERROR_ALREADY
  NOCHAN = bass._BASS_ERROR_NOCHAN
  ILLTYPE = bass._BASS_ERROR_ILLTYPE
  ILLPARAM = bass._BASS_ERROR_ILLPARAM
  NO3D = bass._BASS_ERROR_NO3D
  NOEAX = bass._BASS_ERROR_NOEAX
  DEVICE = bass._BASS_ERROR_DEVICE
  NOPLAY = bass._BASS_ERROR_NOPLAY
  FREQ = bass._BASS_ERROR_FREQ
  NOTFILE = bass._BASS_ERROR_NOTFILE
  NOHW = bass._BASS_ERROR_NOHW
  EMPTY = bass._BASS_ERROR_EMPTY
  NONET = bass._BASS_ERROR_NONET
  CREATE = bass._BASS_ERROR_CREATE
  NOFX = bass._BASS_ERROR_NOFX
  NOTAVAIL = bass._BASS_ERROR_NOTAVAIL
  DECODE = bass._BASS_ERROR_DECODE
  DX = bass._BASS_ERROR_DX
  TIMEOUT = bass._BASS_ERROR_TIMEOUT
  FILEFORM = bass._BASS_ERROR_FILEFORM
  SPEAKER = bass._BASS_ERROR_SPEAKER
  VERSION = bass._BASS_ERROR_VERSION
  CODEC = bass._BASS_ERROR_CODEC
  ENDED = bass._BASS_ERROR_ENDED
  BUSY = bass._BASS_ERROR_BUSY
  NOTAUDIO = bass._BASS_ERROR_NOTAUDIO
  UNSTREAMABLE = bass._BASS_ERROR_UNSTREAMABLE
  UNKNOWN = bass._BASS_ERROR_UNKNOWN
