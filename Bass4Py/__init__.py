...
This documentation will heavily cross-reference to the original BASS documentation to avoid duplicate documentation.
If there are any noticeable differences, this documentation will mention them. The BASS documentation will cover the basics though.
