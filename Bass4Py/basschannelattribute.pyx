...
cdef class BASSCHANNELATTRIBUTE:
 ...
 cpdef Get(BASSCHANNELATTRIBUTE self):
  cdef float value
  cdef bint res
  if self.__attrib==bass.BASS_ATTRIB_MUSIC_VOL_CHAN or self.__attrib==bass.BASS_ATTRIB_MUSIC_VOL_INST: return self.__getmusicvolchan()
  elif self.__attrib==bass.BASS_ATTRIB_NOBUFFER: return self.__getnobuffer()
 ...
 cpdef Set(BASSCHANNELATTRIBUTE self,object value):
  cdef bint res
  if self.__attrib==bass.BASS_ATTRIB_MUSIC_VOL_CHAN or self.__attrib==bass.BASS_ATTRIB_MUSIC_VOL_INST: return self.__setmusicvolchan(<list>value)
  elif self.__attrib==bass.BASS_ATTRIB_NOBUFFER: return self.__setnobuffer(<bint>value)
 ...
 cpdef Slide(BASSCHANNELATTRIBUTE self,object value,DWORD time):
  cdef bint res
  if self.__attrib==bass.BASS_ATTRIB_MUSIC_VOL_CHAN or self.__attrib==bass.BASS_ATTRIB_MUSIC_VOL_INST: return self.__slidemusicvolchan(<list>value,time)
 ...
 cpdef __setnobuffer(BASSCHANNELATTRIBUTE self,bint value):
  bass.BASS_ChannelSetAttribute(self.__channel,self.__attrib,0 if value==True else 1)
  bass.__Evaluate()
  return True
