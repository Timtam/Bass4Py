...
cdef class Channel(ChannelBase):
  ...
  cpdef set_position(Channel self, object pos, DWORD mode=?, bint decodeto=?, bint flush=?, bint inexact=?, bint relative=?, bint scan=?, bint stop_when_seeking=?, bint reset_when_seeking=?)
