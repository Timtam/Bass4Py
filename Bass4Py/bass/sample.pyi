...
class Sample(Evaluable):
  ...
  def free(self) -> bool: ...
  def get_channel(self, only_new: bool) -> Channel: ...
  def get_length(self, mode: int = ...) -> int: ...
  def seconds_to_bytes(self, secs: float) -> int: ...
  def stop(self) -> bool: ...
  
  @staticmethod
  def from_parameters(length: int, freq: int, chans: int, max: int = ..., flags: int = ..., device: Optional[OutputDevice] = ...) -> Sample: ...
  
  @staticmethod
  def from_bytes(data: bytes, max: int = ..., flags: int = ..., length: int = ..., device: Optional[OutputDevice] = ...) -> Sample: ...
  
  @staticmethod
  def from_file(file: Union[str, bytes], max: int = ..., flags: int = ..., device: Optional[OutputDevice] = ...) -> Sample: ...
