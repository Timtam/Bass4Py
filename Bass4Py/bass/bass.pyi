...
class BASS(Evaluable):
  ...
  @property
  def input_devices(self) -> InputDeviceEnumerator: ...

  @property
  def output_devices(self) -> OutputDeviceEnumerator: ...
  ...
  @mf_video.setter
  def mf_video(self, value: bool) -> None: ...
  
  @property
  def mf_disable(self) -> bool: ...
  
  @mf_disable.setter
  def mf_disable(self, value: bool) -> None: ...
